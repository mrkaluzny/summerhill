...
<section class="images_side_by_side py-8 md:py-16 w-full @if ($has_background_color &&
  $default_color) bg-grey-lightest @endif" @if ($has_background_color && !$default_color) style="background-color: {{ $color_picker }}" @endif>
  <div class="container flex flex-col">
    ...
    <div class="flex flex-col md:flex-row mt-8 sm:mt-12 md:mt-16 xl:mt-20">
      <h5
        class="w-full md:w-1/2 md:pr-4 text-h6 md:text-h5 leading-average text-center md:text-left text-black font-heading">
        {{ $title }}</h5>
      <div
