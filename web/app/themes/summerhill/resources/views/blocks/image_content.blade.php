...
<section class="image_content relative w-full @if ($has_background_color && $default_color) bg-grey-lightest @endif @if ($img_transparent_bg)
  has_img_transparent_bg @endif"
  @if ($has_background_color && !$default_color) style="background-color:
    {{ $color_picker }}" @endif>
