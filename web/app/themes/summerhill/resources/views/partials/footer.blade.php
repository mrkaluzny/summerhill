...
<footer class="footer bg-blue-dark">
  <div class="footer__main container  flex flex-col-reverse lg:flex-row pt-14 pb-8 lg:pb-24">
    <div class="w-full lg:w-1/3 flex flex-col lg:pr-4 sm:mt-12 mt-16 md:mt-16 lg:mt-0">
    ...
    <div class="footer__links w-full md:w-4/5 mx-auto lg:w-2/3 flex">
  ...
  <span class="footer__twig absolute">
    @include('icons.twig')
  </span>
</footer>